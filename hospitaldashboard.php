    ...
    <body>
        ...
        <?php
            ...
            if(isset($_POST['query'])){
                $s = $_POST['query'];
                    // echo $s;
                $patients = "SELECT * FROM users WHERE type = 'patient'  AND hid = '$hid' AND name LIKE '%$s%' OR email LIKE '%$s%' ";
            ...
            $res3 = "SELECT COUNT(*) as total FROM users WHERE type = 'patient' AND hid = '$hid' ";
        ...
        <form method="POST" actions="hospitaldashboard.php">
            ...
            <label for="usr"></label>
            <input type="text" class="form-control" name="query" placeholder="Search Patients">
